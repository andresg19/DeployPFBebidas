...
router.post("/checkout", async (req, res) => {
  ...
  let preference = {
    items: [...itemsMapeo],
    back_urls: {
      success: "https://elbardetonibebidas.vercel.app/feedback",
      failure: "https://elbardetonibebidas.vercel.app/feedback",
      pending: "https://elbardetonibebidas.vercel.app/feedback",
    },
